...
public class Lights : IGameInitalizable, IGameLoadable, IGameUpdatable, ISpriteBatchDrawable<BackgroundSpriteBatch>
{
    ...
    {
        LeftTexture = _contentManagerService.LoadTexture2D("lights");
        RightTexture = _contentManagerService.LoadTexture2D("lights");
    ...
    {
        position = new Vector2(position.X - _raceService.GetRailSpeed(), 0);
