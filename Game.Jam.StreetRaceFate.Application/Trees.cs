...
public class Trees : IGameInitalizable, IGameLoadable, IGameUpdatable, ISpriteBatchDrawable<BackgroundSpriteBatch>
{
    ...
    {
        LeftTexture = _contentManagerService.LoadTexture2D("tree");
        RightTexture = _contentManagerService.LoadTexture2D("tree");
