...
public class NewsSpriteBatch : ISpriteBatch
{
    ...
    {
        _spriteBatchFactory.CreateSpriteBatch<NewsSpriteBatch>();
    }

    public void Draw(GameTime gameTime)
    {
        SpriteBatch spriteBatch = _spriteBatchFactory.GetSpriteBatch<NewsSpriteBatch>();

        var matrix = _viewService.GetViewMatrix();

        spriteBatch.Begin(transformMatrix: matrix);

        foreach (ISpriteBatchDrawable<NewsSpriteBatch> spriteBatchDrawable in _weakRefrenceManager.Get<ISpriteBatchDrawable<NewsSpriteBatch>>())
        {
