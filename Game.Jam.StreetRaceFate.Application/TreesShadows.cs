...
public class TreesShadows : IGameInitalizable, IGameLoadable, IGameUpdatable, ISpriteBatchDrawable<BackgroundSpriteBatch>
{
    ...
    {
        LeftTexture = _contentManagerService.LoadTexture2D("tree.shadows");
        RightTexture = _contentManagerService.LoadTexture2D("tree.shadows");
    ...
    {
        position = new Vector2(position.X - _raceService.GetTreesSpeed(), 0);
